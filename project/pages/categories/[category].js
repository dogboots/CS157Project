  ...
  export default function CategoryPage() {
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        {/* Sidebar */}
        <Sidebar isOpen={isOpen} closeSideBar={closeSideBar} selectedItems={selectedItems} calculateTotalPrice={calculateTotalPrice}
          handleCheckout={handleCheckout} router={router}/>
      </div>
    );
  }
